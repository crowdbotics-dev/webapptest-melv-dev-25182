...
## Project Structure
    ...
    ├── webapptest_melv_dev_25182  # Django project configurations
...
1. Clone this repo and `cd webapptest_melv_dev_25182`
...
2. Clone this repo and `cd webapptest_melv_dev_25182`
